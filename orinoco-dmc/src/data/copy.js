export const copy = {
  es: {
    ...
    hero: { eyebrow: 'Destination Management Company · Venezuela', slogan_l1: 'Venezuela,', slogan_l2: 'en su forma', slogan_l3: 'más íntima.', sub: 'Curamos viajes para los que buscan el país antes que la postal.', cta: 'Conoce nuestros itinerarios' },
    about: { eyebrow: 'Quiénes somos', title_l1: 'Un DMC que abre', title_l2: 'Venezuela como', title_l3: 'se abre un libro.', body: 'Somos una compañía de gestión de destino fundada para conectar a viajeros, agencias y operadores con la Venezuela real: la del Salto Ángel y la de los pueblos del Delta, la de los tepuyes y la de los Llanos. Operamos desde dentro, con red local, logística probada y obsesión por el detalle. Cada viaje se diseña a mano, persona por persona.', cta: 'Sobre nosotros' },
    services: { eyebrow: 'Servicios', title: 'Diseñado para tres formas de viajar.', tagline: '[ FITs · GROUPS · M.I.C.E. ]', list: [
    ...
    why: { eyebrow: 'Por qué Venezuela', title_l1: 'Un país que cabe', title_l2: 'muchos países dentro.', body: '2.800.000 km² entre el Caribe, el Amazonas y los Andes. Cuatro horas de vuelo separan un atardecer en Los Roques de un amanecer en la Gran Sabana.', stats: [
    ...
    destinations: { eyebrow: 'Destinos', title_l1: 'Trece lugares,', title_l2: 'trece formas de país.', sub: 'Una selección curada de los enclaves que mejor explican Venezuela. Cada uno se opera con guías locales y red propia.', list: [
    ...
    inspired: { eyebrow: 'Get Inspired', title_l1: 'Itinerarios', title_l2: 'para empezar a imaginar.', sub: 'Plantillas que rediseñamos contigo. Un punto de partida, no una jaula.', list: [
    ...
    contact: { eyebrow: 'Empieza el viaje', title_l1: 'Cuéntanos qué', title_l2: 'Venezuela buscas.', sub: 'Respondemos en 24 horas hábiles. Atendemos a agencias, operadores y viajeros directos.', placeholder_name: 'Nombre', placeholder_company: 'Asunto', placeholder_message: 'Cuéntanos en qué piensas', cta: 'Enviar mensaje', email: 'Email' },
  ...
  en: {
    ...
    hero: { eyebrow: 'Destination Management Company · Venezuela', slogan_l1: 'Venezuela,', slogan_l2: 'in its most', slogan_l3: 'intimate form.', sub: 'We craft travel for those who want the country before the postcard.', cta: 'See our journeys' },
    about: { eyebrow: 'Who we are', title_l1: 'A DMC that opens', title_l2: 'Venezuela the way', title_l3: 'you open a book.', body: 'We are a destination management company built to connect travelers, agencies and tour operators with the real Venezuela: the one of Angel Falls and the one of the Delta villages, the tepuis and the savannahs. We operate from the inside: local network, proven logistics, obsessive attention to detail. Every trip is designed by hand, person by person.', cta: 'About us' },
    services: { eyebrow: 'Services', title: 'Designed for three ways of traveling.', tagline: '[ FITs · GROUPS · M.I.C.E. ]', list: [
    ...
    why: { eyebrow: 'Why Venezuela', title_l1: 'A country that holds', title_l2: 'many countries inside.', body: '2,800,000 km² between the Caribbean, the Amazon and the Andes. Four hours of flight separate a Los Roques sunset from a Gran Sabana sunrise.', stats: [
    ...
    destinations: { eyebrow: 'Destinations', title_l1: 'Thirteen places,', title_l2: 'thirteen versions of a country.', sub: 'A curated selection of the locations that best explain Venezuela. Each one is operated with local guides and our own ground network.', list: [
    ...
    inspired: { eyebrow: 'Get Inspired', title_l1: 'Journeys', title_l2: 'to begin imagining.', sub: 'Templates we rebuild with you. A starting point, never a cage.', list: [
